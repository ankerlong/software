...
#邮件
content="请尽快确认重启结果,服务器IP：10.135.16.64 [$(date +'%F %H:%M:%S')]"
...
OKCODE=200
# dubbo_start.sh
StartDubbo=/home/haieradmin/hac/hac1169-service-impl-2.2.0-SNAPSHOT/bin/start.sh

# 定义要监控的页面地址
WebUrl=http://10.135.16.64:1026/com.haier.openplatform.hac.service.HacUserServiceCli?wsdl
